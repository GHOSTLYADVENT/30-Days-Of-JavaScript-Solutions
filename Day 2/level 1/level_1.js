...
let strs = 'You cannot end a sentence with because because because is a conjunction'

console.log(strs.indexOf('because'))

// ASSIGNMENT 18 

console.log(strs.lastIndexOf('because'))

// ASSIGNMENT 19

console.log(strs.search('because'))
